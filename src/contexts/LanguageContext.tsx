...
// Define nested translation structure types
...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const t = (key: string): any => {
    try {
      // Primero intentamos acceder directamente a la clave (para las claves planas)
      const directAccess = translations[language][key];
      if (directAccess !== undefined) {
        return directAccess;
      }

      // Si no existe acceso directo, intentamos el acceso anidado
      return key
        .split(".")
